...
//             var playerPositionInGrid = new Vector2(playerPosition.x, playerPosition.z);
//             RaycastResult raycastResult = GetBombPositions(playerPositionInGrid);
//             bool shouldPlaceBomb = ShouldPlaceBomb(playerPosition, raycastResult);
//             if (shouldPlaceBomb)
//             {
//                 PlaceBomb();
//             }
